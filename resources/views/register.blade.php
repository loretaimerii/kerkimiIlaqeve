...
<html>
    ...
    <body class="flex flex-col min-h-screen">
        ...
        <div class="flex justify-center flex-grow">
            <div class="w-lg my-28 shadow-2xl rounded-xl p-10">
                <form action="/register" method="POST">
                    @csrf
                     <div class="mb-5">
                        <label class="text-xl mr-24">Name:</label>
                        <input type="text" id="name" name="name" class="bg-white p-2 rounded-sm border-2" required/>
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="">
                        <button type="submit" id="submit" name="submit" class="p-4 rounded-lg text-xl hover:text-white hover:bg-blue-600">Register</button>
                    </div>
                </form>
            </div>
        </div>
